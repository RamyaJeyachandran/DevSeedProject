...
@section('title','Patients Reffered By Doctor')
@section ('style')
    ...
    @include('layouts.sideMenu')
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        <form id="tbRefferedBy-html-filter-form" class="xl:flex sm:mr-auto" >
                        @csrf
                            <div class="sm:flex items-center sm:mr-4">
                                <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Field</label>
                                <select id="tbRefferedBy-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                            ...
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <select id="tbRefferedBy-html-filter-type" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                            ...
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <input id="tbRefferedBy-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="Search...">
                            </div>
                            <div class="mt-2 xl:mt-0">
                                <button id="tbRefferedBy-html-filter-go" type="button" class="btn btn-primary w-full sm:w-16" >Go</button>
                                <button id="tbRefferedBy-html-filter-reset" type="button" class="btn btn-dark w-full sm:w-16 mt-2 sm:mt-0 sm:ml-1" >Reset</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="tbRefferedBy" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
