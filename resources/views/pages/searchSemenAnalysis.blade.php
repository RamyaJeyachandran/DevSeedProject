    ...
    @include('layouts.sideMenu')
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        <form id="tbSemen-html-filter-form" class="xl:flex sm:mr-auto" >
                        @csrf
                            <div class="sm:flex items-center sm:mr-4">
                                <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Field</label>
                                <select id="tbSemen-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                            ...
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <select id="tbSemen-html-filter-type" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                                    <option value="like" selected>like</option>
                                    <option value="=">=</option>
                                </select>
                            </div>
                            <div id="divValueSearch" class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                <label id="tbSemen-html-filter-value-label" class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Value</label>
                                <input id="tbSemen-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="Search...">
                            </div>
                            <div id="divDateSearch" class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                <label id="tbSemen-html-filter-value-1-label" class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Value</label>
                                <input id="tbSemen-html-filter-value-1" type="text" class="datepicker form-control" data-single-mode="true" placeholder="Search...">
                            </div>
                            <div class="mt-2 xl:mt-0">
                                <button id="tbSemen-html-filter-go" type="button" class="btn btn-primary w-full sm:w-16" >Go</button>
                                <button id="tbSemen-html-filter-reset" type="button" class="btn btn-dark w-full sm:w-16 mt-2 sm:mt-0 sm:ml-1" >Reset</button>
                            </div>
                        </form>
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="tbSemen" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
                <!-- BEGIN: Modal Delete Semen --> 
                <div id="divDeleteSemen" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true"> 
                    <div class="modal-dialog"> <div class="modal-content"> 
                        <div class="modal-body p-0"> <div class="p-5 text-center"> 
                            <i data-lucide="x-circle" class="w-16 h-16 text-danger mx-auto mt-3"></i> 
                            <div class="text-3xl mt-5">Do you really want to delete these Semen Analysis?</div> 
                        </div> 
                        <div class="px-5 pb-8 text-center">
                        <input id="txtId" name="id" type="hidden" class="form-control" disabled>
                                <button id="btnDelSemen" type="button" class="btn btn-danger w-24">Delete</button>
            ...
            <!-- END: Modal Delete Semen --> 
            <!-- BEGIN: Error Modal Content --> 
 <div id="divSemenErrorModal" class="modal" tabindex="-1" aria-hidden="true"> 
